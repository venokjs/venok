import type { ContextId, ContextType, ExternalContextOptions, ParamsMetadata, PipeTransform, VenokParamsFactoryInterface } from "@venok/core";

import type { CustomHeader, RedirectResponse } from "~/context/response.controller.js";
import type { ParamData } from "~/decorators/route-params.decorator.js";
import type { RequestMethod } from "~/enums/request-method.enum.js";
import type { RouterProxyCallback } from "~/interfaces/index.js";
import type { HeaderStream } from "~/helpers/sse.helper.js";

import { ApplicationContext, isEmpty, isString, STATIC_CONTEXT, VenokContextCreator } from "@venok/core";
import { Observable } from "rxjs";
import { IncomingMessage } from "http";

import { RouterResponseController } from "~/context/response.controller.js";
import { HEADERS_METADATA, METHOD_METADATA, REDIRECT_METADATA, RESPONSE_PASSTHROUGH_METADATA } from "~/constants.js";
...
import { Render } from "~/decorators/render.decorator.js";
import { Sse } from "~/decorators/sse.decorator.js";
