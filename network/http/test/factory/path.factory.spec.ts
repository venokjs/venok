  ...
  describe("isExcludedFromGlobalPrefix", () => {
    describe("when there is no exclude configuration", () => {
      it("should return false", () => {
        sinon.stub(httpConfig, "getGlobalPrefixOptions").returns({
          exclude: undefined,
        });
        expect(routePathFactory.isExcludedFromGlobalPrefix("/cats", RequestMethod.GET)).to.be.false;
      });
    });
    describe("otherwise", () => {
      ...
      describe("when route is excluded (by path)", () => {
        it("should return true", () => {
          ...
          expect(routePathFactory.isExcludedFromGlobalPrefix("/cats", RequestMethod.GET)).to.be.true;
        });
        ...
        describe("when route is excluded (by method and path)", () => {
          it("should return true", () => {
            ...
            expect(routePathFactory.isExcludedFromGlobalPrefix("/cats", RequestMethod.GET)).to.be.true;
            expect(routePathFactory.isExcludedFromGlobalPrefix("/cats", RequestMethod.POST)).to.be.false;
          });
        });
      });
    });
