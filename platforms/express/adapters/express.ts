...
export class Express extends AbstractHttpAdapter<http.Server | https.Server> {
  ...
  public close() {
    ...
    return new Promise((resolve) => this.httpServer.close(resolve)).then(() => this);
  }
  ...
  public initHttpServer(options: VenokApplicationOptions) {
  ...
  public registerParserMiddleware(prefix?: string, rawBody?: boolean) {
    const bodyParserJsonOptions = getBodyParserOptions(rawBody as boolean);
    const bodyParserUrlencodedOptions = getBodyParserOptions(rawBody as boolean, {
      extended: true,
    });
  ...
  public applyVersionFilter(
    ...
    const callNextHandler: VersionedRoute = (req, res, next) => {
      ...
      return next() as unknown as VersionedRoute;
    };
