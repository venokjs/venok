import { ClassProvider, FactoryProvider, ValueProvider } from "@venok/core/interfaces/modules";
...
describe("provider classifier", () => {
  describe("isClassProvider", () => {
    ...
    it("should return false if useClass is undefined", () => {
      ...
      expect(isClassProvider(classProvider as unknown as ClassProvider)).to.be.false;
    });
  ...
  describe("isValueProvider", () => {
    ...
    it("should return false if provider is undefined", () => {
      ...
      expect(isValueProvider(valueProvider as unknown as ValueProvider)).to.be.false;
    });
  });
  ...
  describe("isFactoryProvider", () => {
    ...
    it("should return false if useFactory is undefined", () => {
      ...
      expect(isFactoryProvider(factoryProvider as unknown as FactoryProvider)).to.be.false;
    });
  });
});
