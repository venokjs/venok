...
describe("HttpExceptionsHandler", () => {
  ...
  describe("next", () => {
    ...
    describe("when exception is an instance of HttpException", () => {
      it("should send expected response status code and json object", () => {
        ...
        handler.next(new HttpException(message, status), new ExecutionContextHost([0, response]));
    ...
    describe('when "invokeCustomFilters" returns true', () => {
      ...
      it("should do nothing", () => {
        handler.next(new Error(), sinon.createStubInstance(ExecutionContextHost));
  ...
  describe("setCustomFilters", () => {
    ...
    it("should throw exception when passed argument is not an array", () => {
      expect(() => handler.setCustomFilters(null as any)).to.throws(InvalidExceptionFilterException);
    });
  });
    ...
    describe("when filters array is not empty", () => {
      ...
      describe("when filter exists in filters array", () => {
        ...
        it("should return true", () => {
          expect(handler.invokeCustomFilters(new TestException(), null as any)).to.be.true;
        });
      });
